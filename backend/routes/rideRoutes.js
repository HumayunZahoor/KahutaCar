...
import { bookRide , getRidesByDriver , updateRideStatus , updateRideStatusbyCustomer , getMyRides , verifySession ,getCompletedRides , createRentRequest , getRentRequestsByCustomer , payRent} from '../controllers/ride.controller.js';
...
rideRoutes.post("/pay-rent", payRent);
